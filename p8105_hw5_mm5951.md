...
The lower the mean, the lower the proportion of times that the null
hypothesis was rejected. That means, there’s a direct association
between effect size and power. **REVIEW**

Next, I make a two-pannel plot showing:

- the average estimate of μ̂ on the y axis and the true value of μ on the
  x axis.
...
<img src="p8105_hw5_mm5951_files/figure-gfm/unnamed-chunk-13-2.png" width="90%" />

**PENDING** Is the sample average of μ̂ across tests for which the null
is rejected approximately equal to the true value of μ? Why or why not?
